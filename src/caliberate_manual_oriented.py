...
parser.add_argument(
    ...
    help="Board orientation relative to camera (clockwise). "
...
def mouse_click(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if len(points) < 4:
            ...
            print("[INFO] Already selected 4 points. Press 'r' to reset or 's' to save.")


# =========================
# REMAP BOARD COORDINATES
# =========================
...
# =========================
print("📸 Instructions:")
print("1️⃣ Place camera in final position.")
print("2️⃣ Click the 4 board corners in this order:")
print("   top-left → top-right → bottom-right → bottom-left")
print("3️⃣ Press 'r' to reset")
print("4️⃣ Press 's' to save sqdict.json")
print("5️⃣ Press 'q' to quit")

print(f"[INFO] Board rotation relative to camera: {CAM_ROT}° clockwise\n")
...
while True:
    ...
    # save calibration
        ...
        if len(points) != 4:
            print("[WARNING] Please select 4 points first.")
            continue
        ...
        print(f"[✅] sqdict.json saved successfully with rotation {CAM_ROT}°.")
